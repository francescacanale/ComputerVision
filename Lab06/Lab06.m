...
% Loading the images:
img1 = imread('InputImages/Mire/Mire1.pgm');
img2 = imread('InputImages/Mire/Mire2.pgm');
% img1 = imread('InputImages/Rubik/Rubik1.pgm');
% img2 = imread('InputImages/Rubik/Rubik2.pgm');

% Showing the images:
figure, imshow([img1 img2]);

% Loading corresponding points:
p1 = load('InputImages/Mire/Mire1.points')';
p2 = load('InputImages/Mire/Mire2.points')';
% p1 = load('InputImages/Rubik/Rubik1.points')';
% p2 = load('InputImages/Rubik/Rubik2.points')';
